...
tribble(
  ...
  "2025", "2025 SPPAC Travel Award", "Society of Pediatric Psychology, Division 54 of the American Psychological Association","Amount: \\$500",
...
**Halbreich, E. D.**, Hefner, T. D., Healy, A. S., & Van Allen, J. (In Prep). Construction and validation of the companion animal ties scale (CATS).
...
Hoelscher, E.C., **Halbreich, E.D.**, & Victor, S. E. (2025, June 26--27). *Feeling the Urge: Interoception and NSSI Urge Frequency in Transgender and Nonbinary Adults*. International Society for the Study of Self-injury 2025 Annual Conference, Wellington, New Zealand.
...
"2024", "Instructor: Andrew K. Littlefield, Ph.D.", "Categorical Data Analysis",
...
tribble(
  ...
  "Course Instructor: Elizabeth Hoelscher, M.A.",
  "Spring 2025",
  "Texas Tech University, Department of Kinesiology & Sport Management",
...
tribble(
  ~Year, ~Organization, ~Desc,
"2025", "APA 2025 Division 54", "Poster and Session Reviewer",
) %>% 
  detailed_entries(
    what = Desc,
    when = Year, 
